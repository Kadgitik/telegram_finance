...
async def cmd_start(message: Message, db: AsyncIOMotorDatabase) -> None:
    ...
    text = (
        ...
        "🏧 Підключи Monobank — транзакції синхронізуються автоматично\n"
        "📤 Або завантаж виписку CSV — без доступу до API\n"
        "📊 Графіки та статистика по категоріях\n"
        "💰 Борги, заощадження та цілі\n"
